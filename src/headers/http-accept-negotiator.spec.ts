...
import { httpAcceptNegotiator } from './http-accept-negotiator';

describe('httpAcceptNegotiator', () => {
  describe('*/*', () => {

    const negotiator = httpAcceptNegotiator({
      '*/*': 'any',
    });
  ...
  describe('text/*', () => {
    ...
    const shorthand = httpAcceptNegotiator({
      text: 'text',
    });
  ...
  describe('Q-factor', () => {
    it('prefers request with higher Q-factor', () => {
      ...
      const negotiator = httpAcceptNegotiator({ 'text/html': 'html', 'text/plain': 'text' });
    ...
    it('prefers wildcard request with higher Q-factor', () => {
      ...
      const negotiator = httpAcceptNegotiator({ 'text/html': 'html', 'text/*': 'text' });
